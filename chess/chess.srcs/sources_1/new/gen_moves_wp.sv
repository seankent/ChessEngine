...
module gen_moves_wp(
    ...
    always_comb begin
        ...
        MOVE_FORWARD_2 = (UNIT << 16) & EMPTY & (EMPTY << 8) & RANK_4;              // move forward 2
        MOVE_RIGHT = (UNIT << 9) & (BLACK_UNITS | (FILE_EP & RANK_6)) & ~FILE_A;    // move right (including en passant)
        MOVE_LEFT = (UNIT << 7) & (BLACK_UNITS | (FILE_EP & RANK_6)) & ~FILE_H;     // move left (including en passant)
